    ...
    case store_types__WEBPACK_IMPORTED_MODULE_3__["FINISH_FILE"]:
      {
        var _update = function _update(file) {
          return [].concat(Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_1__["default"])(file.log), [action.message]);
        };

        var _files = state.files.map(applyFileUpdate(action.id, 'log', action.message, _update)).map(applyFileUpdate(action.id, 'status', store_types__WEBPACK_IMPORTED_MODULE_3__["FileStatus"].Completed, _update));
...
//# sourceMappingURL=_app.js.9a123791a62d309b40f7.hot-update.js.map