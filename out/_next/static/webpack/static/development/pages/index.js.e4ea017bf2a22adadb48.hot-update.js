...
var MAX_TOTAL_BYTES = lib_bytes__WEBPACK_IMPORTED_MODULE_1__["MAX_CHUNK_THRESHOLD"] * 3; // Devise file conversion strategy depending on file count and individual statuses and sizes.
...
function strategize(files) {
    ...
    for (var _iterator = _babel_runtime_corejs2_core_js_get_iterator__WEBPACK_IMPORTED_MODULE_0___default()(files), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      switch (+_file.status) {
        ...
        case store_types__WEBPACK_IMPORTED_MODULE_2__["FileStatus"].Converting:
          processingBytes += _file.size;
          break;

        case store_types__WEBPACK_IMPORTED_MODULE_2__["FileStatus"].Ready:
        case store_types__WEBPACK_IMPORTED_MODULE_2__["FileStatus"].Pending:
          if (_file.size < smallestFileSize) {
            smallestFileSize = _file.size;
          }

          consideredFiles.push(_file);
          break;
      }
    }
  } catch (err) {
  ...
  for (var file in consideredFiles) {
...
//# sourceMappingURL=index.js.e4ea017bf2a22adadb48.hot-update.js.map