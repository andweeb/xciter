    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_2__["default"])(this, "onWorkerMessage", function (event) {
      ...
      switch (data.action) {
        case 'PRINT':
          {
            ...
            _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_3__["updateLog"])(_this.id, data.message, file ? file.status : undefined));

            break;
          }

        case 'PRINT_WARNING':
          _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_3__["updateLog"])(_this.id, data.message, store_types__WEBPACK_IMPORTED_MODULE_4__["FileStatus"].Warning));

          break;

        case 'PRINT_ERROR':
          _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_3__["updateLog"])(_this.id, data.message, store_types__WEBPACK_IMPORTED_MODULE_4__["FileStatus"].Error));
        ...
        case 'RUNTIME_INITIALIZED':
          {
            ...
            _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_3__["updateLog"])(_this.id, 'WebAssembly runtime initialized.', store_types__WEBPACK_IMPORTED_MODULE_4__["FileStatus"].Ready));
        ...
        case 'FILE_CREATED':
          ...
          _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_3__["updateLog"])(_this.id, "Created ".concat(data.name, " in virtual filesystem."), store_types__WEBPACK_IMPORTED_MODULE_4__["FileStatus"].Ready, true));
        ...
        case 'WORKER_COMPLETED':
          _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_3__["finishFile"])(_this.id, "Job completed for ".concat(_this.filename, ".")));
...
//# sourceMappingURL=_app.js.a525d67b26510862317d.hot-update.js.map