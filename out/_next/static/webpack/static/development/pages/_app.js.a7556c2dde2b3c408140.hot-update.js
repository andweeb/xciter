...
/* harmony import */ var store_types__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! store/types */ "./src/store/types.ts");
/* harmony import */ var _xci_worker__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./xci.worker */ "./src/workers/xci.worker.ts");
/* harmony import */ var _xci_worker__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_xci_worker__WEBPACK_IMPORTED_MODULE_6__);
  ...
  function XCIWorker(id, keyset, store) {
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_3__["default"])(this, "onWorkerMessage", function (event) {
      ...
      switch (data.action) {
        ...
        case 'PRINT_WARNING':
          _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_4__["updateLog"])(_this.id, data.message, store_types__WEBPACK_IMPORTED_MODULE_5__["FileStatus"].Warning));

          break;

        case 'PRINT_ERROR':
          _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_4__["updateLog"])(_this.id, data.message, store_types__WEBPACK_IMPORTED_MODULE_5__["FileStatus"].Error));
        ...
        case 'RUNTIME_INITIALIZED':
          {
            ...
            _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_4__["updateLog"])(_this.id, 'WebAssembly runtime initialized.', store_types__WEBPACK_IMPORTED_MODULE_5__["FileStatus"].Ready));
        ...
        case 'FILE_CREATED':
          ...
          _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_4__["updateLog"])(_this.id, "Created ".concat(data.name, " in virtual filesystem."), store_types__WEBPACK_IMPORTED_MODULE_5__["FileStatus"].Ready, true));
        ...
        case 'WORKER_COMPLETED':
          {
            _this.store.dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_4__["finishFile"])(_this.id, "Job completed for ".concat(_this.filename, "."))); // Restrategize and kick-off conversions for files that are ready


            var _files = _this.store.getState().files.files;

            var _strategize = strategize(_files),
            ...
            convertFiles.forEach(function (file) {
              return dispatch(createFile(file.id, file));
            });
            pendingFiles.forEach(function (file) {
              return dispatch(Object(actions_files__WEBPACK_IMPORTED_MODULE_4__["updateLog"])(file.id, 'Pending on ongoing file conversions', store_types__WEBPACK_IMPORTED_MODULE_5__["FileStatus"].Pending));
            });
    ...
    this.id = id;
    this.store = store;
    this.worker = new _xci_worker__WEBPACK_IMPORTED_MODULE_6___default.a();
...
//# sourceMappingURL=_app.js.a7556c2dde2b3c408140.hot-update.js.map